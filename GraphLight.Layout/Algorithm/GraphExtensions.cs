...
namespace GraphLight.Algorithm
{
    ...
    {
        internal static IEnumerable<List<IVertex<V, E>>> GetRankList<V, E>(this IGraph<V, E> graph)
        ...
        internal static IVertex<V, E> InsertControlPoint<V, E>(this IGraph<V, E> graph, IEdge<V, E> edge, V vertexData, E edgeData)
        {
            return graph.InsertVertex(edge, vertexData, edgeData);
        }

        internal static void RemoveControlPoint<V, E>(this IGraph<V, E> graph, IVertex<V, E> vertex)
        {
