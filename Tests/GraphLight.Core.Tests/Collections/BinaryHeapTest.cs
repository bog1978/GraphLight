...
namespace GraphLight.Collections
{
    ...
    public class BinaryHeapTest
    {
        ...
        {
            var heap = new BinaryHeap<int, int>(_testData, x => x, HeapType.Max);
        ...
        {
            var heap = new BinaryHeap<int, int>(new int[] { }, x => x, HeapType.Max);
            var root = heap.Root;
        }
        ...
        {
            var heap = new BinaryHeap<int, int>(_testData, x => x, HeapType.Max) { { 20, 20 } };
            var actual = heap.ToArray();
        ...
        {
            var heap = new BinaryHeap<int, int>(_testData, x => x, HeapType.Min);
            var actual = heap.ToArray();
        ...
        {
            var heap = new BinaryHeap<int, int>(new int[] { }, x => x, HeapType.Min);
            var root = heap.Root;
        }
        ...
        {
            var heap = new BinaryHeap<int, int>(_testData, x => x, HeapType.Min) { { 0, 0 } };
            var actual = heap.ToArray();
