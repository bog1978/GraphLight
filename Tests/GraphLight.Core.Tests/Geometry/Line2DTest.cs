...
namespace GraphLight.Test.Geometry
{
    ...
    public class Line2DTest
    {
        ...
        public void TestEqual()
        {
            ...
            Assert.AreEqual(l1.Cross(l1, out _), CrossType.Equal);
            Assert.AreEqual(l1.Cross(l2, out _), CrossType.Equal);
        }
        ...
        public void TestCross1()
        {
            ...
            Assert.AreEqual(l1.Cross(l2, out _), CrossType.Cross);
        }
        ...
        public void TestJoin()
        {
            ...
            Assert.AreEqual(Line2D.Cross(p1, p2, p1, p3, out _), CrossType.Join);
            Assert.AreEqual(Line2D.Cross(p2, p1, p1, p3, out _), CrossType.Join);
            Assert.AreEqual(Line2D.Cross(p1, p2, p3, p1, out _), CrossType.Join);
            Assert.AreEqual(Line2D.Cross(p2, p1, p3, p1, out _), CrossType.Join);
        }
        ...
        public void TestNoneParallelH()
        {
            ...
            Assert.AreEqual(Line2D.Cross(p1, p2, p3, p4, out _), CrossType.None);
        }
        ...
        {
            Assert.AreEqual(Line2D.Cross(p0, p2, p1, p3, out _), CrossType.Overlap);
            Assert.AreEqual(Line2D.Cross(p0, p2, p0, p1, out _), CrossType.Overlap);
            Assert.AreEqual(Line2D.Cross(p0, p3, p1, p2, out _), CrossType.Overlap);
            Assert.AreEqual(Line2D.Cross(p0, p2, p1, p2, out _), CrossType.Overlap);
            Assert.AreEqual(Line2D.Cross(p0, p2, p1, p3, out _), CrossType.Overlap);
        }
